...
function Navbar(){
  ...
  <div className="navbar-start">
    <div className="dropdown">
      ...
      <ul
        tabIndex="-1"
        className=" text-white text-3xl menu menu-sm dropdown-content bg-base-100 rounded-box z-1 mt-3 w-52 p-2 shadow">
  ...
  <div className="navbar-center">
    <a className="btn btn-ghost text-xl">CoinTracker</a>
  </div>
